...
----- Window Navigation (Windows - no tmux) ------
vim.keymap.set("n", "<C-h>", "<C-w>h", { desc = "Navigate to the left split" })
vim.keymap.set("n", "<C-j>", "<C-w>j", { desc = "Navigate to the bottom split" })
vim.keymap.set("n", "<C-k>", "<C-w>k", { desc = "Navigate to the top split" })
vim.keymap.set("n", "<C-l>", "<C-w>l", { desc = "Navigate to the right split" })
