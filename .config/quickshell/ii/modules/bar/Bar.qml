            ...
            sourceComponent: PanelWindow { // Bar window
                ...
                Item { // Bar content region
                    ...
                    Rectangle {
                        ...
                        color: showBarBackground ? Qt.rgba(0, 0, 0, 0.8) : "transparent"
                        ...
                        Item {
                            ...
                            RowLayout { // Content
                                ...
                                RippleButton {
                                    ...
                                    colBackgroundToggled: "#333333"
                                    colBackgroundToggledHover: Appearance.colors.colSecondaryContainerHover
                                    colRippleToggled: Appearance.colors.colSecondaryContainerActive
                                    toggled: GlobalStates.sidebarLeftOpen
                                    property color colText: toggled ? "#FFFFFF" : Appearance.colors.colOnLayer0
                                    ...
                                    CustomIcon {
                                        ...
                                        width: 19.5
                                        height: 19.5
                                        source: Config.options.bar.topLeftIcon == 'distro' ? SystemInfo.distroIcon : SystemInfo.distroIcon
                                        colorize: true
                    ...
                    RowLayout { // Middle section
                        ...
                        BarGroup {
                            ...
                            // Espacio vacío donde estaban los recursos
                            Item {
                                Layout.fillWidth: true
                            }
                        }
                            ...
                            RowLayout {
                                ...
                                RowLayout {
                                    ...
                                    Item {
                                        ...
                                        Image {
                                            id: kuromiHeart
                                            source: "file:///home/kuro/Desktop/ファイル/Imagenes/クロミ/heart.png"
                                            anchors.fill: parent
                ...
                Loader {
                    ...
                    sourceComponent: Item {
                        ...
                        RoundCorner {
                            ...
                            color: showBarBackground ? "black" : "transparent"
