    ...
    RowLayout {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                opacity: 0 // Changed to 0 to make it invisible
                ...
                background: Item {
                    ...
                    StyledText { // Workspace number text
                        ...
                        text: {
                            ...
                            return kanjiNumbers[button.workspaceValue - 1] || `${button.workspaceValue}`;
                        }
                        elide: Text.ElideRight
                        color: (monitor.activeWorkspace?.id == button.workspaceValue) ?
                            "#FFFFFF" :
                            (workspaceOccupied[index] ? "#888888" :
                    ...
                    Rectangle { // Dot instead of ws number
                        ...
                        color: (monitor.activeWorkspace?.id == button.workspaceValue) ?
                            "#FFFFFF" :
                            (workspaceOccupied[index] ? "#333333" :
                                Appearance.colors.colOnLayer1Inactive)
                    ...
                    Item { // Main app icon
                        ...
                        Loader {
                            active: false // Disabled monochrome icons
