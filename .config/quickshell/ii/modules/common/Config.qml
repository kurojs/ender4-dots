    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string network: "kitty -e nmtui"
            ...
            property JsonObject language: JsonObject {
                property JsonObject translator: JsonObject {
                    property string engine: "google" // Run `trans -list-engines` for available engines. auto should use google
                    property string targetLanguage: "es" // Spanish (español)
                    property string sourceLanguage: "ja" // Japanese (japonés)
                }
            }
