    ...
    contentItem: Item {
        ...
        Rectangle {
            ...
            color: toggled ? 
                root.showToggledHighlight ?
                    (root.down ? Appearance.colors.navigationRailSelectedActive : root.hovered ? Appearance.colors.navigationRailSelectedHover : Appearance.colors.navigationRailSelected)
                    : ColorUtils.transparentize(Appearance.colors.navigationRailSelected) :
        ...
        Item {
            ...
            MaterialSymbol {
                ...
                text: buttonIcon
                color: toggled ? Appearance.colors.navigationRailIcon : Appearance.colors.navigationRailIconInactive
