...
TabButton {
    ...
    property color colBackgroundHover: selected ? ColorUtils.mix(Appearance.colors.todoTabActive, "#FFFFFF", 0.9) : Appearance.colors.colLayer1Hover
    property color colRipple: selected ? ColorUtils.mix(Appearance.colors.todoTabActive, "#FFFFFF", 0.8) : Appearance.colors.colLayer1Active
        ...
        RowLayout {
            ...
            Component {
                ...
                MaterialSymbol {
                    ...
                    fill: selected ? 1 : 0
                    color: selected ? Appearance.colors.todoTabActive : Appearance.colors.todoTabInactive
                    Behavior on color {
                        animation: Appearance.animation.elementMoveFast.colorAnimation.createObject(this)
                    }
                }
