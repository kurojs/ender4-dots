...
Item {
    ...
    StyledListView {
        ...
        interactive: false // We use our own drag handler

        Behavior on implicitWidth {
            animation: Appearance.animation.elementMoveFast.numberAnimation.createObject(this)
        }

        // DragHandler completamente deshabilitado para evitar arrastrar iconos
        // El drag de iconos está deshabilitado por diseño
