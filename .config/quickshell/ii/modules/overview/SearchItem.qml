...
RippleButton {
    ...
    // Safe property bindings with explicit null checks
    property bool entryShown: (entry && entry.hasOwnProperty('shown')) ? entry.shown : true
    property string itemType: (entry && entry.hasOwnProperty('type')) ? entry.type : ""
    property string itemName: (entry && entry.hasOwnProperty('name')) ? entry.name : ""
    property string itemIcon: (entry && entry.hasOwnProperty('icon')) ? entry.icon : ""
    property var itemExecute: (entry && entry.hasOwnProperty('execute')) ? entry.execute : function() {}
    property string fontType: (entry && entry.hasOwnProperty('fontType')) ? entry.fontType : "main"
    property string itemClickActionName: (entry && entry.hasOwnProperty('clickActionName')) ? entry.clickActionName : ""
    property string bigText: (entry && entry.hasOwnProperty('bigText')) ? entry.bigText : ""
    property string materialSymbol: (entry && entry.hasOwnProperty('materialSymbol')) ? entry.materialSymbol : ""
    property string cliphistRawString: (entry && entry.hasOwnProperty('cliphistRawString')) ? entry.cliphistRawString : ""
