    ...
    Loader {
        ...
        sourceComponent: PanelWindow { // Window
            ...
            Rectangle {
                ...
                border.width: Appearance.colors.leftPanelBorderWidth
                border.color: Appearance.colors.leftPanelBorderColor
                radius: Appearance.rounding.screenRounding - Appearance.sizes.hyprlandGapsOut + 1
                
                // Blur effect applied to the whole container
                layer.enabled: Appearance.colors.leftPanelBlur > 0.0
                layer.effect: GaussianBlur {
                    radius: Appearance.colors.leftPanelBlur * 16
