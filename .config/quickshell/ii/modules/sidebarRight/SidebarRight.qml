        ...
        Loader {
            ...
            sourceComponent: Item {
                ...
                Rectangle {
                    ...
                    border.width: Appearance.colors.rightPanelBorderWidth
                    border.color: Appearance.colors.rightPanelBorderColor
                    radius: Appearance.rounding.screenRounding - Appearance.sizes.hyprlandGapsOut + 1
                    
                    // Blur effect applied to the whole container
                    layer.enabled: Appearance.colors.rightPanelBlur > 0.0
                    layer.effect: GaussianBlur {
                        radius: Appearance.colors.rightPanelBlur * 16
                        samples: Math.min(radius * 2 + 1, 25)
