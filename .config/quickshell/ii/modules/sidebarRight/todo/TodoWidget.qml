...
Item {
    ...
    ColumnLayout {
        ...
        Item { // Tab indicator
            ...
            Rectangle {
                ...
                color: Appearance.colors.todoTabActive
    ...
    FloatingActionButton {
        ...
        // Usar colores personalizados para el fondo
        colBackground: Appearance.colors.todoAddButton
        colBackgroundHover: ColorUtils.mix(Appearance.colors.todoAddButton, "#FFFFFF", 0.92)
        colRipple: ColorUtils.mix(Appearance.colors.todoAddButton, "#FFFFFF", 0.85)
        ...
        contentItem: MaterialSymbol {
            ...
            color: "#FFFFFF" // Color del icono sobre el fondo personalizado
        }
    }
    ...
    Item {
        ...
        Rectangle { // The dialog
            ...
            color: Appearance.colors.todoDialogBackground
