...
# Dependencies: slurp, spectacle, imagemagick, tesseract (jpn), translate-shell, wl-clipboard, libnotify
...
# 2. OCR — Japanese text block, strip spaces between chars (OCR artifact)
